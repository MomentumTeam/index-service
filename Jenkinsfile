            ...
            steps {
              script{
                if(env.GIT_BRANCH == 'master') {
                  ...
                  sh "docker build -t  drivehub.azurecr.io/meateam/indexing-error-service:develop ./error-service"
                  sh "docker build -t  drivehub.azurecr.io/meateam/indexing-manager-service:develop ./manager-service"
                  sh "docker build -t  drivehub.azurecr.io/meateam/indexing-parsing-service:develop ./parsing-service"
                  sh "docker build -t  drivehub.azurecr.io/meateam/indexing-search-service:develop ./search-service"

                  sh "docker push  drivehub.azurecr.io/meateam/indexing-delete-service:develop"
                  sh "docker push  drivehub.azurecr.io/meateam/indexing-drive-service:develop"
                  sh "docker push  drivehub.azurecr.io/meateam/indexing-elastic-service:develop"
                  sh "docker push drivehub.azurecr.io/meateam/indexing-error-service:develop"
                  sh "docker push drivehub.azurecr.io/meateam/indexing-manager-service:develop"
                  sh "docker push drivehub.azurecr.io/meateam/indexing-parsing-service:develop"
                  sh "docker push drivehub.azurecr.io/meateam/indexing-search-service:develop"  
                }
              } 
            }
            post {
