...
const clientES = new Client({ node: process.env.ELASTIC_PROTOCOL+"://"+process.env.ELASTIC_HOST+":"+process.env.ELASTIC_PORT });

const permissionClient = new permission_proto.Permission(`${process.env.DRIVE_URL}:${process.env.PERMISSION_SERVICE_PORT}`,
  grpc.credentials.createInsecure());

const fileClient = new file_proto.FileService(`${process.env.DRIVE_URL}:${process.env.FILE_SERVICE_PORT}`,
  grpc.credentials.createInsecure());
